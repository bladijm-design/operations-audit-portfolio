...
| Cancellation without replacement | Sole truck for lane+cutoff | Finding: Capacity Gap |
...
graph TD
    ...
    B -->|HIGH| C[Same-day notification<br/>to responsible owner]
...
| Issue Location | Owner Category |
|---------------|----------------|
| In transport (carrier delay, traffic, driving ban) | Surface Transportation |
| At destination (unloading, capacity, operational) | Last Mile Operations |
| At origin (late sortation, scheduling) | Sort Center Operations |
| Plan infeasible / wrong equipment type | Planning & Scheduling |
...
|-----------|-----------|
| Data collection | Python (fleet management API client, batch processing) |
